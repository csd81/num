...
for i=1:n
    z(i+1)=z(i)+h*f(t(i),z(i))+h^2/2*f1(t(i),z(i))+h^3/6*f2(t(i),z(i));
    t(i+1)=i*h;
...
function w=f1(t,y)       %correction term of the second-order Taylor method
    w=4*y-20*t.^2-16*t+2;
end

function w=f2(t,y)       %correction term of the third-order Taylor method
